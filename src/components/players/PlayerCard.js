  ...
  if (compact) {
    return (
      <div
        ...
        data-id="j2caxp99i"
        data-path="components/players/PlayerCard.js"
      >
        <img
        ...
        <div data-id="qyff7jemr" data-path="components/players/PlayerCard.js">
          ...
          >
            <span
              className={`inline-block px-2 py-0.5 text-xs rounded border ${getSkillBadgeClass(player.skill_level)}`}
              data-id="mz99ag0q6"
              data-path="components/players/PlayerCard.js"
            >
        ...
        {showChallengeButton && !isActivePlayer && (
          <Button
            ...
            icon={
              <i
                className="fas fa-trophy text-primary"
                data-id="rt9q671nf"
                data-path="components/players/PlayerCard.js"
              ></i>
            }
  ...
  return (
    ...
    >
      <div className="relative" data-id="w4t56wx6c" data-path="components/players/PlayerCard.js">
        {/* Cover image */}
        <div
          className="h-20 bg-gradient-to-r from-primary to-secondary"
          data-id="gdz0rocre"
          data-path="components/players/PlayerCard.js"
        ></div>
      ...
      >
        ...
        >
          <span
            className={`px-2 py-1 text-xs rounded border ${getSkillBadgeClass(player.skill_level)}`}
            data-id="ruf49up5u"
            data-path="components/players/PlayerCard.js"
          >
            {formatSkillLevel(player.skill_level)}
